...
angular.module('frontendApp')
  .controller('ImageFromFBCtrl', function ($scope, $sce, $cookies, $window, $rootScope, Config, modalInstance, $uibModal, MediaStoryService , param) {
    ...
    self.BackToCreate = function BackToCreate() {
      modalInstance.get().close();
    ...
    /*---------------------------------
     ...
     -------------------------------- */
    self.openEditMediaStoryModal = function openEditMediaStoryModal() {
