...
/**
 * @ngdoc function
 * @name frontendApp.controller:newGroupCtrl
 * @description
 * # newGroupCtrl
 * Controller of the frontendApp
 */
angular.module('frontendApp')
  .controller('newGroupCtrl', function ($scope, UserService, mainService, $uibModalInstance) {
    ...
    self.createNewGroup = function createNewGroup() {
      if(self.newGroupName === '') {
        ...
        UserService.createNewGroup(self.newGroupName, self.selectedFriends, function(response) {
          console.log('createNewGroup = ', response);
          self.closeModal();
        });
      }
    };
    ...
    self.getAllGroup = function() {
      ...
      console.log('self.allGroup = ', self.allGroup);
    };
